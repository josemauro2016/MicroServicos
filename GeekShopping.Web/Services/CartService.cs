...
namespace GeekShopping.Web.Services
{
    public class CartService : ICartService
    {
        ...
        public Task<bool> ApplyCoupon(CartVielModel cart, string couponCode, string token)
        {
            throw new NotImplementedException();
        }

        public async Task<CartVielModel> Checkout(CartHeaderViewModel cartHeader, string token)
        {
            throw new NotImplementedException();
        }
